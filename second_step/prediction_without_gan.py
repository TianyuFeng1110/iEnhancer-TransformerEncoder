...
class Encoder():
    def __init__(self, batch_size=32, lr=0.0001, num_epochs=500, seq_len=200, model_name='transformer_encoder', hidden=128, k_mer_size=1, \
                num_gpus=1, dropout=0.1, k_fold=10, strong_enhancers_dir='../train_datas/predication/2l_strong_enhancer.txt', weak_enhancers_dir='../train_datas/predication/2l_weak_enhancer.txt'):
...
def main(argv=None):
    ...
    parser.add_argument("--model_name", default="predict_without_gan", help="model name for checkpoint and output")
